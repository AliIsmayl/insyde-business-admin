...
function buildPromoCode() {
  const raw = (localStorage.getItem("businessName") || localStorage.getItem("username") || "BIZ")
    .replace(/[^A-Z0-9]/gi, "")
    .toUpperCase()
    .slice(0, 5);
  return raw ? `INS${raw}` : "INSBIZ25";
}
...
const HOW_IT_WORKS = [
  ...
  },
  {
    ...
    desc: "Sahibkar paketdə qazanc sabit faizlə hesablanır. Korporativ paketdə isə qazanc daha cəlbedici olur. Paylaşdığınız hər müştəridən daha çox gəlir əldə edə bilərsiniz.",
  },
];

export default function PromoMain() {
                ...
                {infoOpen && (
                  <div className="promo-info-popup">
                    ...
                    <ol className="promo-info-popup-steps">
                      <li>İstifadəçi <strong>Paketlər</strong> hissəsinə keçid edir</li>
                      <li>Uyğun paket və ödəniş müddəti seçilir</li>
                      <li><strong>Ödəniş mərhələsində</strong> promo kod sahəsi görünür</li>
