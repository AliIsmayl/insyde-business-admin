...
/*
  ...
  │ title       : string                                │
  │ message     : string                                │
  │ confirmText : string   (default: type-ə görə)       │
  │ cancelText  : string   (default: "Ləğv et")         │
  │ onConfirm   : () => void                            │
  │ onCancel    : () => void                            │
  └─────────────────────────────────────────────────────┘
  ...
  // 1. STATE QURĞUSU (komponentin yuxarısında)
  const [popup, setPopup] = useState({ isOpen: false, type: "success" });
  const closePopup = () => setPopup((p) => ({ ...p, isOpen: false }));

  // ──────────────────────────────────────────────────
  // 2. SUCCESS — məlumat saxlanıldı və s.
  // ──────────────────────────────────────────────────
  // <button onClick={() => setPopup({ isOpen: true, type: "success" })}>Yadda saxla</button>
  //
  // <Popup
  //   isOpen={popup.isOpen}
  //   type="success"
  ...
  // ──────────────────────────────────────────────────
  // 3. DELETE — bir elementi silmək
  // ──────────────────────────────────────────────────
  // <button onClick={() => setPopup({ isOpen: true, type: "delete" })}>Sil</button>
  //
  // <Popup
  //   isOpen={popup.isOpen}
  //   type="delete"
  ...
  //   confirmText="Sil"
  //   onConfirm={() => { handleDelete(); closePopup(); }}
  //   onCancel={closePopup}
  // />

  // ──────────────────────────────────────────────────
  // 4. ERROR — xəta baş verdi
  // ──────────────────────────────────────────────────
  // <Popup
  //   isOpen={popup.isOpen}
  //   type="error"
  //   title="Xəta baş verdi!"
  //   message="Server ilə əlaqə qurulmadı. Yenidən cəhd edin."
  //   onConfirm={closePopup}
  //   onCancel={closePopup}
  // />

  // ──────────────────────────────────────────────────
  // 5. BLOCK — istifadəçini bloklamaq
  // ──────────────────────────────────────────────────
  // <button onClick={() => setPopup({ isOpen: true, type: "block" })}>Blokla</button>
  //
  // <Popup
  //   isOpen={popup.isOpen}
  //   type="block"
  ...
  //   confirmText="Blokla"
  //   onConfirm={() => { handleBlock(); closePopup(); }}
  //   onCancel={closePopup}
  // />
*/
...
const CONFIG = {
  ...
  error: {
    ...
    cancelable: false, // error-da yalnız 1 düymə
  },
  block: {
    Icon: FiSlash,
